  ...
  return (
    <View style={styles.view} className="main-container">
      ...
      <View style={{paddingLeft: 90, paddingRight: 90, paddingBottom: 150}}>
        <Button style={[styles.button, {backgroundColor: "#001E6A",}]} color="#ffffff" onPress={() => router.push("/inscription")}><Text style={{fontFamily: "Inconsolata_400Regular"}}>S'inscrire</Text></Button>

        <Button style={[styles.button, {backgroundColor: "#FF6700", borderColor: "#FF6700"}]} color="#ffffff" onPress={() => router.push("/connexion")}><Text style={{fontFamily: "Inconsolata_400Regular"}}>Se connecter</Text></Button>
